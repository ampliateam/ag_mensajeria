import { IConfigMensajeriaProfesional, IMensajeria, IMensajeriaPack } from "@global/models/interfaces";
...
export const mongoToMensajeriaPack = (mongo: any): IMensajeriaPack => {
    return mongoToModel(mongo) as IMensajeriaPack;
}
